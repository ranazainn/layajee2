                    ...
                    <div class="card">
                        <div class="card-content">
                            ...
                            <div id="card-stats" class="row">
                                <div class="col s12 m6 xl3">
                                    <div class="card">
                                        <div class="card-content cyan white-text">
                                            <p class="card-stats-title"><i class="material-icons">person_outline</i>Total User</p>
                                ...
                                <div class="col s12 m6 xl3">
                                    <div class="card">
                                        <div class="card-content red accent-1 white-text">
                                            <p class="card-stats-title"><i class="material-icons">time_to_leave</i>Total Driver</p>
                                            <h4 class="card-stats-number white-text">{{$driver}}</h4>
                                        </div>
                                ...
                                <div class="col s12 m6 xl3">
                                    <div class="card">
                                        <div class="card-content orange lighten-1 white-text">
                                            <p class="card-stats-title"><i class="material-icons">beenhere</i>Assigned 
                                             Booking</p>
                                            <h4 class="card-stats-number white-text">{{$assign}}</h4>
                                ...
                                <div class="col s12 m6 xl3">
                                    <div class="card">
                                        <div class="card-content green lighten-1 white-text">
                                            <p class="card-stats-title"><i class="material-icons">block</i>Unassigned 
                                            Booking</p>
                                            <h4 class="card-stats-number white-text">{{$unassign}}</h4>
                                        </div>
                                ...
                                <div class="col s12 m6 xl3">
                                    <div class="card">
                                        <div class="card-content purple white-text">
                                            <p class="card-stats-title"><i class="material-icons">airline_seat_recline_normal</i>Reserved 
                                             Driver</p>
                                            <h4 class="card-stats-number white-text">{{$reserve??'0'}}</h4>
                                        </div>
                                ...
                                <div class="col s12 m6 xl3">
                                    <div class="card">
                                        <div class="card-content  blue-grey white-text">
                                            <p class="card-stats-title"><i class="material-icons">directions_walk</i>Unreserved 
                                             Driver</p>
                                            <h4 class="card-stats-number white-text">{{$unreserve??'0'}}</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
