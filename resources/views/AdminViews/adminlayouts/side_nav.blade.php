  ...
  <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
    <div class="brand-sidebar">
      <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="{{route('home')}}"> <span class="logo-text hide-on-med-and-down">Layajee Admin</span></a><a class="navbar-toggler" href="#"></a></h1>
    </div>
    <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
      ...
      <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="#"><i class="material-icons">dvr</i><span class="menu-title" data-i18n="">Customer</span></a>
        <div class="collapsible-body">
          <ul class="collapsible collapsible-sub" data-collapsible="accordion">

            <li><a class="collapsible-body" href="{{route('customer-get')}}" data-i18n=""><i class="material-icons">radio_button_unchecked</i><span>Customer list</span></a>
            </li>
          </ul>
        </div>
      </li>
      ...
      <!-- </ul> -->
      <!-- <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="#"><i class="material-icons">settings_input_svideo</i><span class="menu-title" data-i18n="">Users</span></a>
      <div class="collapsible-body">
        <ul class="collapsible collapsible-sub" data-collapsible="accordion">
          <li><a class="collapsible-body" href="dashboard-modern.html" data-i18n=""><i class="material-icons">radio_button_unchecked</i><span>Drivers</span></a>
          </li>
          <li><a class="collapsible-body" href="{{route('getUserList')}}" data-i18n=""><i class="material-icons">radio_button_unchecked</i><span>User</span></a>
          </li>
        </ul>
      </div>
    </li> -->
      ...
      <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="#"><i class="material-icons">track_changes</i><span class="menu-title" data-i18n="">Provider</span></a>
        <div class="collapsible-body">
          <ul class="collapsible collapsible-sub" data-collapsible="accordion">
            <li><a class="collapsible-body" href="{{route('provider-get')}}" data-i18n=""><i class="material-icons">radio_button_unchecked</i><span>Provider list</span></a>
            </li>
          </ul>
        </div>
      </li>

      <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="#"><i class="material-icons">local_parking</i><span class="menu-title" data-i18n="">Settings</span></a>
        <div class="collapsible-body">
          <ul class="collapsible collapsible-sub" data-collapsible="accordion">
            <li><a class="collapsible-body" href="dashboard-modern.html" data-i18n=""><i class="material-icons">radio_button_unchecked</i><span>Promo Code Price</span></a>
            </li>
            <li><a class="collapsible-body" href="{{route('notification')}}" data-i18n=""><i class="material-icons">radio_button_unchecked</i><span>Notification</span></a>
            </li>
          </ul>
        </div>
      </li>
