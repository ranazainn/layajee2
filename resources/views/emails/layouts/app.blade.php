                ...
                <td valign="top">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="4">
                                    ...
                                    @yield('content')
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#878200">
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                <td valign="middle" align="center"
                                                    ...
                                                    <a href="{!! Config::get('settings.facebook_url') !!}"
                                                        target="_blank"
                                                        style="width:30px;height:26px;margin:0 5px;display:inline-block;"><img
                                                            src="{{asset('assets/email/fbpng-min.png')}}" alt="facebook"
                                                            width="24" /></a>
                                                    <a href="{!! Config::get('settings.twitter_url') !!}"
                                                        target="_blank"
                                                        style="width:30px;height:26px;margin:0 5px;display:inline-block;"><img
                                                            src="{{asset('assets/email/twipng-min.png')}}" alt="twitter"
                                                            width="24" /></a>
                                                    <a href="{!! Config::get('settings.instagram_url') !!}"
                                                        target="_blank"
                                                        style="width:30px;height:26px;margin:0 5px;display:inline-block;"><img
                                                            src="{{asset('assets/email/instpng-min.png')}}"
                                                            alt="Instagram" width="24" /></a>
                                                    <a href="https://wa.me/{!! Config::get('settings.contact_number')  !!}/?text=contactus"
                                                        data-text="share" target="_blank"
                                                        style="width:30px;height:26px;margin:0 5px;display:inline-block;"><img
                                                            src="{{asset('assets/email/whtspng-min.png')}}"
                                            ...
                                            <tr>
                                                <td valign="middle" align="center"
                                                    style="font-size: 14px;line-height: 26px;color: #fff;padding-left:30px;padding-right:30px">
                                                    {!! Config::get('settings.telephone_number') !!}</td>
                                            </tr>
                                            <tr>
                                                <td valign="middle" align="center"
                                                    style="font-size: 14px;line-height: 26px;color: #fff;padding-left:30px;padding-right:30px">
                                                    {!! Config::get('settings.contact_email') !!}</td>
                                            </tr>
                                            <tr>
                                                <td height="15"></td>
                                            </tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tbody>
                            ...
                            <tr>
                                <td valign="top" align="center"><span style="color:#333;font-size:12px">© <a
                                            href="{!! url('/') !!}"
                                            style="color:#0dcadd;font-weight: 500; font-size:12px;text-decoration:none;">{!!
                                            config('settings.company_name') !!}</a> {!!
                                        \Carbon\Carbon::now()->format('Y') !!}</span></td>
                            </tr>
                            <tr>
                                <td height="50">&nbsp;</td>
                            </tr>
